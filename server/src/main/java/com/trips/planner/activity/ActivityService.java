...
public class ActivityService {
    ...
    public ActivityResponse registerActivity(ActivityRequestPayload payload, TripVO trip){
        ActivityVO newActivity = new ActivityVO(payload.title(), payload.occurs_at(), trip);
